...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $m1 = Matelas::factory()->create([
            ...
            //sizes()->attach([$s90x190->id, $s140x190->id]),
        ]);
        ...
        /* Matelas::factory()->create([
            ...
            'price' => '759.00',
            'discount_price' => '529.00',
            sizes()->attach($s140x190), //pas besoin de préciser l'id quand il n'y en a qu'un ?
        ]);
